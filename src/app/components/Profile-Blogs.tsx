      ...
      <div className="flex max-w-3xl flex-wrap justify-center gap-6">
        {user.savedBlogs.map((blog: Blog) => {
          return (
            <article
              key={blog.id}
              className="flex size-60 max-w-60 cursor-pointer items-center justify-center bg-accent/50 p-6 text-center transition duration-300 ease-in-out hover:bg-accent/100 hover:text-white"
            >
